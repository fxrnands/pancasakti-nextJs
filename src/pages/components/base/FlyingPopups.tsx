...
export default function FlyingPopups() {
  return (
    <>
      <div
        aria-live="assertive"
        className="pointer-events-none fixed inset-0 flex items-start px-4 py-6  mt-[32rem] lg:mt-[40rem] left-36 lg:justify-end"
      >
        <div className="flex w-full flex-col items-center space-y-4 sm:items-end">
          <div className="pointer-events-auto cursor-pointer w-[11rem] lg:w-[13.5rem] max-w-sm overflow-hidden rounded-lg hover:bg-green-500 bg-primary-green ">
