  ...
  return (
    <>
      ...
      <div className="relative lg:flex grid grid-flow-row auto-rows-max">
        <div className="lg:p-0 bg-gradient-to-b from-yellow-300 to-sky-100 h-[79rem] md:h-[rem] lg:h-[45rem] lg:w-[50%] p-2 items-center lg:flex justify-center rounded-md">
          <div className="absolute px-2 lg:h-[50rem] lg:w-[40rem]">
            ...
            <div>
              <ul className="px-6 mb-2 mt-2 ml-4 text-gray-800 lg:px-4 lg:text-md list-decimal">
                <li>
